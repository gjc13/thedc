...
//	double_to_string((double)eQEP1PositionDifference,(char*)sciBSendBuffer);
//
//	double_to_string((double)eQEP2PositionDifference,(char*)sciBSendBuffer);
	double_to_string(nowAngle,(char*)sciBSendBuffer);
	strcat((char*)sciBSendBuffer,"        ");
	double_to_string((double)gGyro.z,(char*)sciBSendBuffer);
	strcat((char*)sciBSendBuffer,"\r\n");
